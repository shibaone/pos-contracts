...
contract ERC20Predicate is IErcPredicate {
    ...
    function startExitWithBurntTokens(bytes calldata data) external {
        ...
        withdrawManager.addExitToQueue(
            msg.sender, childToken, rootToken, exitAmount, bytes32(0x0), true, /* isRegularExit */ age << 1
        );
    }
        ...
        returns (address, /* rootToken */ uint256 /* exitAmount */ )
    {
        ...
        referenceTxData.age = withdrawManager.verifyInclusion(data, 0, false) /* offset */ /* verifyTxInclusion */
        ...
        returns (address, /* rootToken */ uint256 /* exitAmount */ )
    {
        ...
        if (referenceTx.length > 10) {
            ...
            _referenceTxData.age = withdrawManager.verifyInclusion(data, 10, false) /* offset */ /* verifyTxInclusion */
        ...
        returns (bool)
    {
        ...
        referenceTxData.age =
            withdrawManager.verifyInclusion(challengeData, 0, true) /* verifyTxInclusion */ .add(referenceTxData.age);
        require(
